...
class Message extends Component {
  ...
  // 对 chatMsgs 按 chat_id 进行分组，并得到每个组的lastMsg组成的数组
  // 1. 找出每个聊天的lastMsg并用一个对象容器来保存{chat_id, lastMsg}
  // 2. 得到所有lastMsg的数组
  ...
  getLastMsgs = (chatMsgs, userid) => {
    ...
    // 3. 对数组进行排序（按create_time降序）
    lastMsgs.sort(function(m1, m2){ // 如果结果<0,将m1放在前面
